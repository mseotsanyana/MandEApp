...
public class COrganizationWorkspaceFragment extends Fragment implements iOrganizationPresenter.View {
    ...
    // adapters
    private cOrganizationWorkspaceAdapter organizationAdapter;
    ...
    private SessionOrganizationWorkspaceFragmentBinding binding;
    Gson gson = new Gson();

    public COrganizationWorkspaceFragment() {
    }

    public static COrganizationWorkspaceFragment newInstance() {
        return new COrganizationWorkspaceFragment();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.session_organization_workspace_fragment,
                container, false);
    ...
    private void setAdapter(cIndexedLinkedHashMap<String, COrganizationModel> organizationModels) {
        if (organizationAdapter == null) {
            organizationAdapter = new cOrganizationWorkspaceAdapter(getActivity(),
    ...
    private void setAdapter(List<cTreeModel> organizationTreeModels) {
        if (organizationAdapter == null) {
            ...
            try {
                organizationAdapter.notifyTreeModelChanged(organizationTreeModels);
