...
public class cBookKeepingFragment extends Fragment {
    private static String TAG = cBookKeepingFragment.class.getSimpleName();

    private Toolbar toolBar;

    private cBookKeepingFragment(){

    }

    public static cBookKeepingFragment newInstance(long logFrameID) {
        Bundle bundle = new Bundle();
        cBookKeepingFragment fragment = new cBookKeepingFragment();
    ...
    public cBookKeepingFragment newInstance() {
        cBookKeepingFragment fragment = new cBookKeepingFragment();
        return fragment;
    }
