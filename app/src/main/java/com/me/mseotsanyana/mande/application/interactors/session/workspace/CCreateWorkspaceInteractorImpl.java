...
public class CCreateWorkspaceInteractorImpl extends CAbstractInteractor<IResponseDTO<Object>>
    ...
    @Override
    public void run() {
        this.workspaceRepository.createWorkspace(workspaceModel, new CFirestoreCallBack() {
                    @Override
                    public void onFirebaseSuccess(Object object) {
                        if (object != null) {
                            IResponseDTO<Object> responseModel;
                            responseModel = new CResponseDTO<>(EAction.Created_WORKSPACE,
                    ...
                    public void onFirebaseFailure(Object object) {
                        postError("Failed to create workspace! -> "+object);
                    }
                });
    }
}