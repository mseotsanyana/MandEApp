...
@Parent
@SingleTop
@Layout(R.layout.me_ownership_heading)
public class cHeadingView {
    ...
    public cHeadingView(Context context, String heading) {
    ...
    public void onResolved() {
        ...
        toggleIcon.setTextColor(context.getColor(R.color.colorPrimaryDark));
