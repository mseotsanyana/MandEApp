...
public class cDependencyRegisterFragment extends Fragment {
    private static String TAG = cDependencyRegisterFragment.class.getSimpleName();

    private Toolbar toolBar;

    private cDependencyRegisterFragment(){

    }

    public static cDependencyRegisterFragment newInstance(long logFrameID) {
        Bundle bundle = new Bundle();
        cDependencyRegisterFragment fragment = new cDependencyRegisterFragment();
    ...
    public cDependencyRegisterFragment newInstance() {
        return new cDependencyRegisterFragment();
    }
