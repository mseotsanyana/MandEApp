...
public class ComponentParentCardviewBindingImpl extends ComponentParentCardviewBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.textViewDeleteIcon, 12);
        sViewsWithIds.put(R.id.textViewUpdateIcon, 13);
        sViewsWithIds.put(R.id.textViewDetailIcon, 14);
    }
    // views
    @NonNull
    ...
    public ComponentParentCardviewBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 15, sIncludes, sViewsWithIds));
    }
    private ComponentParentCardviewBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
