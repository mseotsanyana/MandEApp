...
public class cAssumptionRegisterFragment extends Fragment {
    private static String TAG = cAssumptionRegisterFragment.class.getSimpleName();

    private Toolbar toolBar;

    private cAssumptionRegisterFragment(){

    }

    public static cAssumptionRegisterFragment newInstance(long logFrameID) {
        Bundle bundle = new Bundle();
        cAssumptionRegisterFragment fragment = new cAssumptionRegisterFragment();
    ...
    public cAssumptionRegisterFragment newInstance() {
        return new cAssumptionRegisterFragment();
    }
