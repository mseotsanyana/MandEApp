...
public class cLearningPlanFragment extends Fragment {
    private static String TAG = cLearningPlanFragment.class.getSimpleName();

    private Toolbar toolBar;

    private cLearningPlanFragment(){

    }

    public static cLearningPlanFragment newInstance(long logFrameID) {
        Bundle bundle = new Bundle();
        cLearningPlanFragment fragment = new cLearningPlanFragment();
