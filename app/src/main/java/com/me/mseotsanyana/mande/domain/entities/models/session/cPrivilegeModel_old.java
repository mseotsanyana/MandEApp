...
public class cPrivilegeModel_old {
    ...
    public cPrivilegeModel_old(){}

    public cPrivilegeModel_old(cPrivilegeModel_old operationModel){
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof cPrivilegeModel_old)) return false;
        cPrivilegeModel_old that = (cPrivilegeModel_old) o;
