...
public class cReadProjectInteractorImpl extends cAbstractInteractor
        implements iProjectInteractor {
    private static final String TAG = cReadProjectInteractorImpl.class.getSimpleName();
    ...
    public cReadProjectInteractorImpl(iExecutor threadExecutor, iMainThread mainThread,
    ...
    private void postMessage(List<cTreeModel> treeModels) {
        mainThread.post(() -> callback.onReadProjectsCompleted(treeModels));
    }

    /* return failure message to the main thread */
    private void notifyError(String msg) {
        mainThread.post(() -> callback.onReadProjectsFailed(msg));
    }
                ...
                if ((this.entitypermBITS & cSharedPreference.READ) != 0) {
                    ...
                    projectRepository.readProjects(organizationServerID, userServerID,
                            ...
                            new iProjectRepository.iReadProjectsCallback() {
                                @Override
                                public void onReadProjectSucceeded(List<cProjectModel> projectModels) {
