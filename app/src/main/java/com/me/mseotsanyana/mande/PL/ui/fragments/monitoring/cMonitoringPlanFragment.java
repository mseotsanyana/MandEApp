...
public class cMonitoringPlanFragment extends Fragment {
    private static String TAG = cMonitoringPlanFragment.class.getSimpleName();

    private Toolbar toolBar;

    private cMonitoringPlanFragment(){

    }

    public static cMonitoringPlanFragment newInstance(long logFrameID) {
        Bundle bundle = new Bundle();
        cMonitoringPlanFragment fragment = new cMonitoringPlanFragment();
