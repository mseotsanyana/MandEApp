...
public class LogframeListFragmentBindingImpl extends LogframeListFragmentBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.logFrameRecyclerView, 2);
        sViewsWithIds.put(R.id.logFrameFAB, 3);
    }
    // views
    @Nullable
    ...
    public LogframeListFragmentBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }
    private LogframeListFragmentBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
