...
public class cExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(R.layout.me_list_group_child, null);
        }
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        else if (menuModels.get(groupPosition).getMenuServerID() == 16)
        ...
        else if (menuModels.get(groupPosition).getMenuServerID() == 2048)
