...
public class cIssueRegisterFragment extends Fragment {
    private static String TAG = cIssueRegisterFragment.class.getSimpleName();

    private Toolbar toolBar;

    private cIssueRegisterFragment(){

    }

    public static cIssueRegisterFragment newInstance(long logFrameID) {
        Bundle bundle = new Bundle();
        cIssueRegisterFragment fragment = new cIssueRegisterFragment();
    ...
    public cIssueRegisterFragment newInstance() {
        return new cIssueRegisterFragment();
    }
