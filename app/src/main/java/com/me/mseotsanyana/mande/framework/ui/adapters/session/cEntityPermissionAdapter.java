...
public class cEntityPermissionAdapter extends cTreeAdapter implements Filterable {
...
//    private static final SimpleDateFormat sdf = cConstant.SHORT_FORMAT_DATE;
    ...
    public cEntityPermissionAdapter(Context context, List<cTreeModel> entityOperationTree) {
        super(context, entityOperationTree);
    ...
    public RecyclerView.ViewHolder OnCreateTreeViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case TEAM:
                view = inflater.inflate(R.layout.session_child_workspace_cardview, parent,
                        false);
